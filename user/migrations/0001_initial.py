# Generated by Django 3.2.5 on 2021-09-23 03:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login_method', models.CharField(choices=[('email', 'Email'), ('naver', 'naver'), ('kakao', 'Kakao')], default='email', max_length=6)),
            ...
            managers=[
                ('objects', user.models.CustomUserModelManager()),
            ],
        ),
    ]
